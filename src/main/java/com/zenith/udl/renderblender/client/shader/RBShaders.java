...
import com.zenith.udl.renderblender.api.client.shader.CCShaderInstance;
...
public class RBShaders {
    ...
    public static void onRegisterShaders(RegisterShadersEvent event) {
        ...
        COSMIC_SHADER = CCShaderInstance.create(event.getResourceProvider(), new ResourceLocation(Udl.MODID, "cosmic"), DefaultVertexFormat.BLOCK);
        COSMIC_ARMOR_SHADER = CCShaderInstance.create(event.getResourceProvider(), new ResourceLocation(Udl.MODID, "cosmic"), DefaultVertexFormat.NEW_ENTITY);
        ETERNAL_SHADER = CCShaderInstance.create(event.getResourceProvider(), new ResourceLocation(Udl.MODID, "eternal"), DefaultVertexFormat.BLOCK);
        HELL_SHADER = CCShaderInstance.create(event.getResourceProvider(), new ResourceLocation(Udl.MODID, "hell"), DefaultVertexFormat.BLOCK);
        UNSTABLE_SHADER = CCShaderInstance.create(event.getResourceProvider(), new ResourceLocation(Udl.MODID, "unstable"), DefaultVertexFormat.BLOCK);
        GLOW_EDGE_SHADER = CCShaderInstance.create(event.getResourceProvider(), new ResourceLocation(Udl.MODID, "glow_edge"), DefaultVertexFormat.NEW_ENTITY);
